...
class SpotSliderWidget extends AbstractWidget
{
    protected static $viewAlias = 'rich_shop::views.widgets.spotSlider';
    ...
    protected function getImage($fileId)
    {
        ...
        if ($fileId != '') {
            ...
            $productImage = Image::getThumbnail($image, 'fit', '1140x500');
        }
