        ...
        <div class="default-list-tab">
            <ul>
                @foreach ($categoryChildren as $item)
                    <li><a href="{{instanceRoute('items', ['categoryItemId' => $item->id, 'categoryItemDepth' => $config->get('categoryItemDepth') + 1])}}">{{xe_trans($item->word)}}</a></li>
                @endforeach
            </ul>
            ...
            @foreach($paginate as $item)
                <li>
                    <div class="default-list-img">
                        <a href="{{route('rich_shop.item', ['slug' => $item->slug->slug])}}"><img src="{{ $item->getThumbnail('450x600') }}" alt="{{ $item->product_name }}"></a>
                    ...
                    <div class="default-list-text">
                        <a href="{{route('rich_shop.item', ['slug' => $item->slug->slug])}}">
