...
<div class="products">
    @foreach ($items as $item)
        <div class="item">
            ...
            <div class="rich-shop-widget-thumb" data-url="{{route('rich_shop.settings.widget.image.upload', ['size' => '1140x500'])}}">
                <input type="text" name="product_file_id[]" class="file-id" value="{{$item['product_file_id']}}" />
                상품 썸네일 등록(1140 * 500px) <input type="file" class="product-image" >
                <div class="img">
